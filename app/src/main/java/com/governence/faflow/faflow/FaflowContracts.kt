...
interface LeaveRepository {
    ...
    suspend fun applyLeave(date: String, periodNumber: Int, reason: String, proposedSubstituteId: Int? = null, policyWarningAcknowledged: Boolean = false): NetworkResult<LeaveRequest>
